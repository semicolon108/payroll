    ...
    <div class="page-content">
      ...
      <div class="field">
        ...
        <div class="control">
          <ValidationProvider v-slot="{ errors }">
            <textarea
              v-model="form.basicInfo.address"
              class="textarea"
            ></textarea>
            <p class="has-text-danger">{{ errors[0] }}</p>
          </ValidationProvider>
        ...
        <div class="column">
          <div class="field">
            ...
            <div class="control">
              <ValidationProvider v-slot="{ errors }">
                <input
                  v-model="form.contactPerson.mobile"
                  type="text"
                  class="input"
                />
                <p class="has-text-danger">{{ errors[0] }}</p>
          ...
          <div class="field">
            ...
            <div class="control">
              ...
              <select class="input" v-model="form.financialInfo.bankId">
                <option :value="i._id" v-for="i in banks" :key="i._id">
                  {{ i.name }}
                </option>
              </select>
              <!--              <p class="has-text-danger">{{ errors[0] }}</p>-->
        ...
        <div class="column">
          <div class="field">
            ...
            <div class="control">
              <ValidationProvider v-slot="{ errors }">
                <input
                  v-model="form.financialInfo.accountNumber"
                  type="text"
                  class="input"
                />
                <p class="has-text-danger">{{ errors[0] }}</p>
...
export default {
  ...
  async created() {
    ...
    this.form = {
      ...
      financialInfo: {
        bankId: this.getCompany.financialInfo.bankId
          ? this.getCompany.financialInfo.bankId._id
          : this.banks[0]._id,
