<template>
  <div class="customise-page">
    ...
    <div class="page-header no-shadow">
      <div class="header-start">
        <div class="input-group">
          <input
            ...
            value="Table Layout Name"
          />
          <button class="button sub" @click="updatePayrollLayout">
            Update
          </button>
          <button class="button grey" @click="reset">Reset</button>
          <span></span>
        </div>
      </div>
      ...
      <div class="selected-items">
        ...
        <draggable class="selected-items-list" v-model="form.layouts">
          ...
          >
            ...
            <i
              class="fal fa-times"
              @click="form.layouts = form.layouts.filter((o) => o !== i)"
            ></i>
          </div>
        </draggable>
      </div>
