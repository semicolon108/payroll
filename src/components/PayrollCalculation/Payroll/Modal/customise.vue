    ...
    <div class="customise-page" >
        ...
        <div class="page-header">
            <div class="input-group">
                ...
                <button class="button sub" @click="updatePayrollLayout">
                    Update
                </button>
                <button class="button grey" @click="reset">
                    Reset
                </button>
                <span></span>
            </div>
            ...
            <div class="selected-items">
                ...
                <draggable class="selected-items-list" v-model="form.layouts">
                    <div class="selected-item" v-for="(i, index) in form.layouts" :key="index">
                        <span>{{ index + 1 }}.</span>
                        <p>{{ convertName(i) }}</p>
                        <i class="fal fa-times" @click="form.layouts = form.layouts.filter(o => o !== i)"></i>
                    </div>
                </draggable>
            </div>
                    ...
                    <div class="unselect-item-group" v-for="i in type" :key="i">
                        ...
                        <ul class="active">
                            <li v-for="item in items(i)" :key="item.name">
                                <input @change="item.isSelected = !item.isSelected" type="checkbox" :checked="item.isSelected" :id="item.name">
