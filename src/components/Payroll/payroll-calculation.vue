    ...
    <div class="box fullpage">
          ...
          <div class="box-control-header">
            ...
            <div class="button-group">
              ...
              <button
                  v-else
                  @click="calcPayroll"
                  class="button is-primary">Calculate</button>
            </div>
          </div>
      </div>
      ...
      <div class="box">
        <div class="box-header">
          <div class="button-group">
              <button class="button">All Employee</button>
              <button class="button">Local Employee</button>
              <button class="button active">Expat Employee</button>
        ...
        <table class="table is-fullwidth" id="my-table">
          ...
          <tr v-for="(i, idx) in items" :key="idx">
            ...
            <td class="is-right">
              <div class="workday">
                <div v-if="!editWorkday" class="edit">
                  <span @click="editWorkday = true"><i class="fas fa-pen"></i></span>
                  <span>24</span>
                </div>
                <div class="workdday-input" v-if="editWorkday">
                  <span class="save">Save</span>
                  <input class="input" type="text">
                  <span @click="editWorkday = false">&times;</span>
                </div>
              </div>
            </td>
            <td class="is-right">2,000,000</td>
            ...
            <td class="is-right">{{ i.salary | currency }}</td>
