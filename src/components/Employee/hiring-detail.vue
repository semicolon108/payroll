<template>
    <div>
        <div class="form-header">
            <h3>Hiring Detail</h3>
            <p>Please enter the hiring detail below. The information entered in previous steps is saved and you can always come back to complete this screen from the employees page.</p>
        </div>
