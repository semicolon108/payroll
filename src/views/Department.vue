            ...
            <td>
              <div class="icons">
                <span
                  ...
                  @click="editModal(i._id, i.name)"
                >
                  <i class="fas fa-pen"></i>
                </span>
                <span
                  @click="deleteDepartment(i._id)"
    ...
    async deleteDepartment(departmentId) {
      try {
        ...
        if (message === "Deleted") {
          ...
          const curIdx = this.departments.findIndex(
            (i) => i._id === departmentId
          );
        ...
        if (
          ...
          "You need to delete this positions first"
        ) {
          alert(
            err.graphQLErrors[0].message +
              ": " +
              err.graphQLErrors[0].extensions.positionExists.map((i) => i.name)
          );
        }
      }
    },
