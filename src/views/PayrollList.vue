                        ...
                        <div class="box-header-end">
                            <div class="select">
                                <select v-model="workGroupId" name="" id="">
                                    <option disabled selected value="">select work group</option>
                                    <option v-for="i in workGroups " :key="i._id" :value="i._id">{{i.name}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr v-for="i in t" :key="i._id">
                                        ...
                                        <td class="is-right">
                                            <div v-if="i.isApproved" class="option is-primary">
                                                <router-link :to="{ name: 'calculate_wage', params: { id: i.monthlyPaymentId } }">
